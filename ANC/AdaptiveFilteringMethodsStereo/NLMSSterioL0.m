function [ error, MSerror, timeOfConvergence,timeOfComputation,  w1, w2, filters1, filters2] = NLMSSterioL0( referenceSignal1,referenceSignal2, filtredSignal, fs, filterSize, convergenceThreshold, lambda )
% This function implements the L0 norm Sterio version of NLMS algorithm.
% Lambda is the penelizing factor.
...
%      i
               ...
               w1 = w1 + mu*x_n1*e +k.*ExponentialAprrox(beta,w1) ;
               w2 = w2 + mu*x_n2*e +k.*ExponentialAprrox(beta,w2) ;
