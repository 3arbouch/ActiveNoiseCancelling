function [ error, MSerror, timeOfConvergence,timeOfComputation,  w1, w2, filters1, filters2] = LMSSterioL0( referenceSignal1,referenceSignal2, filtredSignal, fs, filterSize, convergenceThreshold, mu1, mu2, lambda )
% This function implements the Sterio version of LMS algorithm.
...
%      i
               ...
               w1 = w1 + mu1*x_n1*e +k1.*ExponentialAprrox(beta,w1) ;
               w2 = w2 + mu2*x_n2*e +k2.*ExponentialAprrox(beta,w2) ;
