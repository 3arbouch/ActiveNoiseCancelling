function [ error, MSerror, timeOfConvergence,timeOfComputation,  w1, w2, filters1, filters2] = NLMSSterioL1( referenceSignal1,referenceSignal2, filtredSignal, fs, filterSize, convergenceThreshold,lambda )
% This function implements the L1 norm Sterio version of NLMS algorithm.
...
%      i
               ...
               w1 = w1 + mu*x_n1*e - k*sign(w1) ;
               w2 = w2 + mu*x_n2*e - k*sign(w2) ;
