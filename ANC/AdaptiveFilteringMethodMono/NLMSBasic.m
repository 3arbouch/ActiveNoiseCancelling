function [ error , MSerror, timeOfConvergence, timeOfComputation , w, filters ] = NLMSBasic( referenceSignal, filtredSignal, filterSize, convergenceThreshold )
% This function implement the classic version of NLMS algotihm.
...
% Define the frame Size. TODO: Take from UI.
frameSize = 1024 ; 
...
while(i<numberofIterations)
               ...
               % Get the reference signal and compute the error
               x_n = x(i+filterSize-1:-1:i) ; 
               e = d(i+filterSize-1) - x_n'*w  ;  
               
               % Calculat the step size
               mu = 1/(x_n'*x_n)   ; 
