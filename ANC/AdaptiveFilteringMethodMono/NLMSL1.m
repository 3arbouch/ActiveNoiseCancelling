function [ error , MSerror, timeOfConvergence, timeOfComputation , w, filters ] = NLMSL1( referenceSignal, filtredSignal, filterSize, convergenceThreshold,lambda )
% This function implement the L1 norm version of the NLMS algorithm. 
