function [ error, MSerror, timeOfConvergence,timeOfComputation,  w1, w2, filters1, filters2, weights1, weights2, variances1,variances2] = NLMSSterioL0Weighted( referenceSignal1,referenceSignal2, filtredSignal, fs, filterSize, convergenceThreshold, mu_k1, mu_k2, interval1, interval2, upperLimit, memoryInSeconds )
% This function implements the L0 weighted Sterio version of NLMS algorithm.
...
%      i
               ...
               w1 = w1 + mu*x_n1*e +k1.*ExponentialAprrox(beta,w1) ;
               w2 = w2 + mu*x_n2*e +k2.*ExponentialAprrox(beta,w2) ;
